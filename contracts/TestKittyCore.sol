...
contract TestKittyCore is KittyCore {
    ...
    // create promo kitty which is added to the address of the sender
    ...
    // Make a kitty pregnant. It creates promo kitties if required as they are the only kind of kitties generated by this system
    ...
    // transfer a kitty token to another random address
    // creates a promot kitty for sender account if they own no kitties
    ...
    /*function testCreateGen0Kitty() public {
        ...
        // auction is the only way ownership for a minted gen0 kitty is decided
    }*/
}
